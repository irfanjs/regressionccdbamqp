...
public class RegccHelper {
	 static Logger log = Logger.getLogger(RegccHelper.class.getName());
	
	static private RegccHelper cihelper;
	...
	public static RegccHelper getInstance(){
		synchronized (cihelperLock) {
			if(null == cihelper){
				cihelper = new RegccHelper();
			}
		}
		return cihelper;
	}
